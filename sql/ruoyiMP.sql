...
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler','H1608309802423',1608309940371,15000);
...
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1608309810000,-1,5,'PAUSED','CRON',1608309802000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1608309810000,-1,5,'PAUSED','CRON',1608309802000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1608309820000,-1,5,'PAUSED','CRON',1608309802000,0,NULL,2,'');
...
CREATE TABLE `sys_logininfor` (
  ...
  `version` int(11) DEFAULT '0' COMMENT '乐观锁',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1339973777954275331 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-12-19 12:52:54
